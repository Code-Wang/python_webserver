...
class UpdateStocksHandler(BaseHandler):
    ...
    def add_sales_data(self):
        ...
        sql = "insert into sales_data (Id, SalersManName, ItemId, ItemName, ItemCounts, Price, TotalPrice, CustomerName, CustomerTelphone, CustomerAddress, Date)" \
    ...
    def add_stocks_data(self):
        ...
        sql = "insert into stocks_data (Id, ItemId, ItemName, ItemCounts, Price, TotalPrice, Date)" \
